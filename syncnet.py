...
class Dataset(object):
    def __init__(
        ...
        self.negative_pair_mode = negative_pair_mode
        self.negative_pair_window = negative_pair_window
    ...
    def __getitem__(self, idx):
        ...
        audio_idx, label = sample_syncnet_audio_index(
            ...
            negative_pair_mode=self.negative_pair_mode,
            negative_pair_window=self.negative_pair_window,
        )
...
def train(save_dir, dataset_dir, mode, negative_pair_prob, negative_pair_mode, negative_pair_window):
    ...
    train_dataset = Dataset(
        ...
        negative_pair_window=negative_pair_window,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--negative_pair_window', type=int, default=30)
    ...
    train(
        ...
        opt.dataset_dir,
        opt.asr,
        opt.negative_pair_prob,
        opt.negative_pair_mode,
        opt.negative_pair_window,
    )
